...
function updateVisibility() {
  ...
  els.roofFactorWrap.classList.toggle("hidden", !hasRoof);
...
function calculate() {
  ...
  const oneFloorArea = width * length;
...
async function copyResult() {
  ...
  try {
    ...
    alert("Máy đang chặn copy tự động. Sếp copy thủ công giúp tôi.");
  }
}
